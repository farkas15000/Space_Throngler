...
class Menu:
    ...
    def load(self):
        ...
        self.soundSlider = Slider(sprites=Assets.soundSprites, name=1, scale=(3, 3), pos=pygame.Vector2(0, 370), relativeOffset=(0, 0), popup=(1.04, 1.04), pos_map=(531, 681), value_map=(0, 100), step_size=5)
        ...
        self.exitButton = Button(sprites=Assets.buttonSprites, name=0, scale=(2, 2), relativeOffset=(-0.5, -0.5), popup=(1.06, 1.06))
        self.exitButton.scale = (3, 3)

        self.mobileToggle = not Sm.app.mobile

        self.easterEggSlider = Slider(sprites=Assets.soundSprites, name=1, scale=(3, 3), pos=pygame.Vector2(0, 370), relativeOffset=(0, 0), popup=(1.04, 1.04), pos_map=(84, 234), value_map=(50, 400), step_size=1)
    ...
    def menu(self):
        ...
        if self.easterEgg >= 10:
            ...
            if scale != self.easterEggSlider.value:
                Sm.app.monsterScale = round(self.easterEggSlider.value / 100, 1)
            Assets.font_white.write(f'Size:{round(Sm.app.monsterScale, 1)}x', scale=(2, 2), pos=(52, 400))
        ...
        offset.x *= 1.4
        Assets.monsterSprites.draw(name=1, scale=(1.6, 1.6), pos=eye_pos, relativeOffset=(0, 0), offset=offset)
